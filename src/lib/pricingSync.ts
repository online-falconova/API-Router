...
// ─── Provider mapping: LiteLLM provider → API Router aliases ─────
...
/**
 * Transform LiteLLM raw data → API Router PricingByProvider format.
 *
 * Conversion: cost_per_token × 1_000_000 → $/1M tokens (API Router format).

 ...
 *
 * Serves the API Router A2A Agent Card for discovery by other agents.
 ...
 *
 * Returns the API Router Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "API Router AI Gateway",
    description:
    ...
    skills: [
      ...
      },
      {
        ...
        description:
          "Returns the full catalog of 42 API Router agent skills (22 API + 20 CLI) " +

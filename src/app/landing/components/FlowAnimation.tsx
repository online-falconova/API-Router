  ...
  return (
    <div className="mt-16 w-full max-w-4xl overflow-hidden">
      <div className="relative h-[360px] hidden md:flex items-center justify-center animate-[float_6s_ease-in-out_infinite] overflow-hidden">
        {/* API Router Hub - Center */}
        <div className="relative z-20 w-32 h-32 rounded-full bg-[#111520] border-2 border-[#DC2626] shadow-[0_0_40px_rgba(220, 38, 38,0.3)] flex flex-col items-center justify-center gap-1 group cursor-pointer hover:scale-105 transition-transform duration-500">
          <span className="material-symbols-outlined text-4xl text-[#DC2626]" aria-hidden="true">
            hub
          </span>
          <span className="text-xs font-bold text-white tracking-widest uppercase">
            {t("brandName")}
          </span>
          <div className="absolute inset-0 rounded-full border border-[#DC2626]/30 animate-ping opacity-20"></div>
        </div>
        ...
        <div className="absolute left-0 top-1/2 -translate-y-1/2 flex flex-col gap-7">
          {cliTools.map((tool) => (
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-[#111520] border border-[#2D333B] flex items-center justify-center overflow-hidden p-2 hover:border-[#DC2626]/50 transition-all hover:scale-105">
        ...
        {/* SVG Lines from CLI to API Router */}
        <svg
        ...
        {/* SVG Lines from API Router to Providers */}
        <svg
        ...
        >
          <path
            ...
            fill="none"
            stroke={activeFlow === 0 ? "#DC2626" : "rgb(75, 85, 99)"}
          ...
          <path
            ...
            fill="none"
            stroke={activeFlow === 1 ? "#DC2626" : "rgb(75, 85, 99)"}
          ...
          <path
            ...
            fill="none"
            stroke={activeFlow === 2 ? "#DC2626" : "rgb(75, 85, 99)"}
          ...
          <path
            ...
            fill="none"
            stroke={activeFlow === 3 ? "#DC2626" : "rgb(75, 85, 99)"}
          ...
          {providers.map((provider, idx) => (
            <div
              ...
              className={`px-3 py-2 rounded-lg ${provider.color} ${provider.textColor} flex items-center justify-center font-bold text-[11px] leading-tight text-center shadow-lg hover:scale-110 transition-all cursor-help min-w-[110px] max-w-[140px] ${
                activeFlow === idx ? "ring-4 ring-[#DC2626]/50 scale-110" : ""
              }`}
              title={provider.name}
            >
              {provider.name}

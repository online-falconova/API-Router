...
export default function HeroSection() {
  ...
  return (
    <section className="relative pt-32 pb-20 px-4 sm:px-6 min-h-[90vh] flex flex-col items-center justify-center overflow-hidden">
      {/* Glow effect */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1000px] h-[500px] bg-[#DC2626]/10 rounded-full blur-[120px] pointer-events-none"></div>

      <div className="relative z-10 max-w-4xl w-full text-center flex flex-col items-center gap-8">
        {/* Version badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-[#2D333B] bg-[#111520]/50 px-3 py-1 text-xs font-medium text-[#DC2626]">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-black leading-[1.1] tracking-tight break-words">
          {t("oneEndpoint")} <br />
          <span className="text-[#DC2626]">{t("allProviders")}</span>
        </h1>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 w-full">
          <button
            ...
            className="w-full sm:w-auto h-12 px-8 rounded-lg bg-[#DC2626] hover:bg-[#B91C1C] text-white text-base font-bold transition-all shadow-[0_0_15px_rgba(220, 38, 38,0.4)] flex items-center justify-center gap-2"
          >

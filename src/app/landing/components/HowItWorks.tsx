    ...
    <section className="py-24 border-y border-[#2D333B] bg-[#111520]/30" id="how-it-works">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {/* Connection line */}
          <div className="hidden md:block absolute top-12 left-[16%] right-[16%] h-[2px] bg-linear-to-r from-gray-700 via-[#DC2626] to-gray-700 -z-10"></div>
          ...
          {/* Step 2: API Router Hub */}
          <div className="flex flex-col gap-6 relative group md:items-center md:text-center">
            <div className="w-24 h-24 rounded-2xl bg-[#0B0E14] border-2 border-[#DC2626] flex items-center justify-center shadow-[0_0_30px_rgba(220, 38, 38,0.2)] z-10 mx-auto">
              <span
                className="material-symbols-outlined text-4xl text-[#DC2626] animate-pulse"
                aria-hidden="true"
              >
                hub
              </span>
            ...
            <div>
              <h3 className="text-xl font-bold mb-2 text-[#DC2626] break-words">

          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4 min-w-0">
                <div className="flex-none w-8 h-8 rounded-full bg-[#DC2626]/20 text-[#DC2626] flex items-center justify-center font-bold">
                  1
                </div>
                <div>
            ...
            <div className="rounded-xl overflow-hidden bg-[#161B22] border border-[#2D333B] shadow-2xl">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-hidden">
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#DC2626]">&gt;</span> {t("startingOmniRoute")}
                  <br />
                  <span className="text-[#DC2626]">&gt;</span> {t("serverRunningOnLabel")}{" "}
                  <span className="text-blue-400 break-all">{endpoint}</span>
                  <br />
                  <span className="text-[#DC2626]">&gt;</span> {t("dashboardLabel")}:{" "}

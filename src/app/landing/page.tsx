...
export default function LandingPage() {
  ...
  return (
    <div className="relative text-white font-sans overflow-x-hidden antialiased selection:bg-[#DC2626] selection:text-white">
      {/* Animated Background */}
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-[#0B0E14]">
        ...
        <div className="absolute top-0 left-1/4 w-[700px] h-[700px] bg-[#DC2626]/12 rounded-full blur-[130px] animate-blob"></div>
        <div
      ...
      <div className="relative z-10">
        ...
        <main>
          ...
          <section className="py-24 sm:py-32 px-4 sm:px-6 relative overflow-hidden">
            <div className="absolute inset-0 bg-linear-to-t from-[#DC2626]/5 to-transparent pointer-events-none"></div>
            <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  ...
                  className="w-full sm:w-auto h-14 px-10 rounded-lg bg-[#DC2626] hover:bg-[#B91C1C] text-white text-lg font-bold transition-all shadow-[0_0_20px_rgba(220, 38, 38,0.5)]"
                >
                  {t("startFree")}
                </button>
                <button

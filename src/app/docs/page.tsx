...
export const metadata: Metadata = {
  title: "API Router Documentation",
  description:
    "Everything you need to route, compress, and scale your AI — setup guides, API reference, compression, deployment, and more.",
  openGraph: {
    title: "API Router Documentation",
    description:
      "Comprehensive docs for API Router AI gateway — setup, API, compression, deployment, and more.",
    type: "website",
  ...
  twitter: {
    ...
    title: "API Router Documentation",
    description: "Comprehensive docs for API Router AI gateway",
  },
};
...
const featuredLinks = [
  {
    ...
    title: "Quick Start",
    icon: "rocket_launch",
    desc: "Get API Router running in 3 minutes",
  },
  {
    href: "/docs/getting-started/auto-combo-guide",
    title: "Auto-Combo Guide",
    icon: "auto_awesome",
    desc: "Let API Router pick the best AI for you",
  },
  {
  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      <div className="text-center mb-16 mt-8">
        <h1 className="text-4xl font-bold text-fd-foreground mb-5">API Router Documentation</h1>

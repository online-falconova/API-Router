      ...
      <div className="relative">
        <select
          ...
          className={cn(
            ...
            // Neumorphic recessed field. Keeps bg-surface so <option> contrast is safe.
            "bg-surface border border-black/5 dark:border-white/5 rounded-control appearance-none neu-inset",
